-- CreateEnum
CREATE TYPE "Tier" AS ENUM ('FREE', 'HATCHLING', 'DRAKE', 'ELDER_DRAGON');

-- CreateEnum
CREATE TYPE "ContentStatus" AS ENUM ('DRAFT', 'SCHEDULED', 'PROCESSING', 'POSTED', 'FAILED');
...
-- AddForeignKey
ALTER TABLE "ContentItem" ADD CONSTRAINT "ContentItem_tiktokAccountId_fkey" FOREIGN KEY ("tiktokAccountId") REFERENCES "TikTokAccount"("id") ON DELETE SET NULL ON UPDATE CASCADE;

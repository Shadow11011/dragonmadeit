...
export function DragonMascot({ size = 32, color = "#ff4500" }: DragonMascotProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <g className="dragon-eye" style={{ transformOrigin: "24px 26px" }}>
        <ellipse cx="24" cy="26" rx="4" ry="5" fill={color} opacity="0.3" />
        <ellipse cx="24" cy="26" rx="2.5" ry="3.5" fill={color} />
        <ellipse cx="24.5" cy="25" rx="1" ry="1.5" fill="#fff" opacity="0.8" />
      </g>

      {/* Right eye */}
      <g className="dragon-eye" style={{ transformOrigin: "40px 26px" }}>
        <ellipse cx="40" cy="26" rx="4" ry="5" fill={color} opacity="0.3" />
        <ellipse cx="40" cy="26" rx="2.5" ry="3.5" fill={color} />
      ...
      {/* Nostrils */}
      <circle cx="29" cy="36" r="1.5" fill={color} opacity="0.5" />
      <circle cx="35" cy="36" r="1.5" fill={color} opacity="0.5" />
